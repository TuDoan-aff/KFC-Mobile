...
import { Text } from 'react-native'; // Thêm Text nếu chưa có
...
// SỬA LẠI ĐƯỜNG DẪN IMPORT (Đảm bảo file này nằm trong thư mục Screen)
  ...
  return (
    <NavigationContainer>
      <RootStack.Navigator>
        ...
        {/* Các màn hình phụ ẩn Bottom Tab */}
        ...
        <RootStack.Screen name="CheckoutScreen" component={CheckoutScreen} options={{ headerShown: true, title: 'Thanh toán' }} />
        ...
        <RootStack.Screen name="MyorderScreen" component={MyorderScreen} options={{ headerShown: true, title: 'Đơn hàng của tôi' }} />
        
        {/* ĐĂNG KÝ CHATBOT VÀO ĐÂY */}
        <RootStack.Screen 
          name="ChatBotScreen" 
